...
/**
 * close_file - Close files descrptors.
 ...
 *              Exits with code 98 if file_from doesnt exist or cant be read.
 *              Exits with code 99 if file_to cannot be created or written to.
 *              Exits with code 100 if either file_to or file_from cant be clsd
 */
